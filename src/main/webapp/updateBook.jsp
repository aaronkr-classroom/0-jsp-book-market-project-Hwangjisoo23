...
<div class = "container py-4">
	...
	<div class = "col-md-7">
		<form name = "newBook" action="./processUpdateBook.jsp" method = "post" enctype = "multipart/form-date">
			<div class = "mb-3 row">
			...
			<div class = "mb-3 row">
				...
				<div class = "col-sm-5">
					<input type = "text" name = "name" id = "name" form-control" value = '<%=rs.getString("b_name")%>'>
				</div>
			</div>
			<div class = "mb-3 row">
			...
			<div class = "mb-3 row">
					...
					<div class = "col-sm-5">
						<input type = "text" name = "rlraseDate" class = "form-control" value = '<%=rs.getString("b_releaseDate")%>'>
						</div>
					</div>
					<div class = "mb-3 row">
					<label class = "col-sm-2">상제정보</label>
					<div class = "col-sm-8">
			...
			<div class = "mb-3 row">
				...
				<div class = "col-sm-8">
					...
					<input type = "radio" name = "condition" value = "Oid"> 중고도서
					<input type = "radio" name = "condition" value = "EEBook"> E-Book
				</div>
			</div>
			<div class = "md-3 row">
